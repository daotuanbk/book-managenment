...
// EXTERNAL MODULE: ./components/book-managenment/Container.tsx
...
// CONCATENATED MODULE: ./components/lent-managenment/LentHistoryList.tsx
...
var LentHistoryList_LentHistoryList =
/*#__PURE__*/
function (_React$Component) {
  _inherits(LentHistoryList, _React$Component);

  function LentHistoryList() {
    _classCallCheck(this, LentHistoryList);

    return _possibleConstructorReturn(this, (LentHistoryList.__proto__ || Object.getPrototypeOf(LentHistoryList)).apply(this, arguments));
  }

  _createClass(LentHistoryList, [{
    key: "render",
    value: function render() {
      var _this = this;
      ...
      return external__react_["createElement"]("div", {
        ...
        pagination: {
          ...
          onChange: function onChange(page, pageSize) {
            _this.props.lentPageReducer.getLentByUserIdEffect({
              userId: _this.props.profileState._id,
              pageNumber: page,
              pageSize: pageSize,
...
/* harmony default export */ var lent_managenment_LentHistoryList = (LentHistoryList_LentHistoryList);
// CONCATENATED MODULE: ./pages/lent-history.tsx
...
function lent_history__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { lent_history__typeof = function _typeof(obj) { return typeof obj; }; } else { lent_history__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return lent_history__typeof(obj); }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step("next", value); } function _throw(err) { step("throw", err); } _next(); }); }; }

function lent_history__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function lent_history__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function lent_history__createClass(Constructor, protoProps, staticProps) { if (protoProps) lent_history__defineProperties(Constructor.prototype, protoProps); if (staticProps) lent_history__defineProperties(Constructor, staticProps); return Constructor; }

function lent_history__possibleConstructorReturn(self, call) { if (call && (lent_history__typeof(call) === "object" || typeof call === "function")) { return call; } return lent_history__assertThisInitialized(self); }

function lent_history__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function lent_history__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var lent_history_LentHistory =
/*#__PURE__*/
function (_React$Component) {
  lent_history__inherits(LentHistory, _React$Component);

  function LentHistory() {
    var _ref;

    var _temp, _this;

    lent_history__classCallCheck(this, LentHistory);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return lent_history__possibleConstructorReturn(_this, (_temp = _this = lent_history__possibleConstructorReturn(this, (_ref = LentHistory.__proto__ || Object.getPrototypeOf(LentHistory)).call.apply(_ref, [this].concat(args))), Object.defineProperty(lent_history__assertThisInitialized(_this), "logOut", {
      configurable: true,
      enumerable: true,
      writable: true,
  ...
  lent_history__createClass(LentHistory, [{
    key: "render",
    value: function render() {
      return external__react_["createElement"]("div", null, external__react_["createElement"](Header["a" /* default */], {
        userEmail: this.props.profileState.email,
        logOut: this.logOut,
        _id: this.props.profileState._id,
        roles: this.props.profileState.roles
      }), external__react_["createElement"](Container["a" /* default */], null, external__react_["createElement"](spin__default.a, {
      ...
      }, external__react_["createElement"]("h1", null, "Lent History"), external__react_["createElement"]("hr", null)), external__react_["createElement"]("div", {
        style: {
          background: '#fff'
        }
      }, external__react_["createElement"](lent_managenment_LentHistoryList, this.props))))));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                profileState = props.store.getState().profileState;
                _context.next = 4;
                return props.store.dispatch.lentPageModel.getLentByUserIdEffect({
...
/* harmony default export */ var lent_history = __webpack_exports__["default"] = (Object(withRematch["a" /* default */])(store["b" /* initStore */], mapState, mapDispatch)(lent_history_LentHistory));
