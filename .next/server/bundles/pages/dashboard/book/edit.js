...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_antd_lib_input_number_style_css__ = __webpack_require__(61);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_antd_lib_input_number__ = __webpack_require__(62);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_antd_lib_upload_style_css__ = __webpack_require__(63);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_antd_lib_upload__ = __webpack_require__(64);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_antd_lib_button_style_css__ = __webpack_require__(12);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_antd_lib_button__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_antd_lib_icon_style_css__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_antd_lib_icon__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_antd_lib_row_style_css__ = __webpack_require__(18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_antd_lib_row_style_css___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_antd_lib_row_style_css__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_antd_lib_row__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9_antd_lib_row___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9_antd_lib_row__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__babel_runtime_regenerator__ = __webpack_require__(0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_antd_lib_input_style_css__ = __webpack_require__(35);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_input__ = __webpack_require__(36);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_antd_lib_input___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_antd_lib_input__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_antd_lib_form_style_css__ = __webpack_require__(45);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_antd_lib_form__ = __webpack_require__(46);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17_react__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__components_admin_layout__ = __webpack_require__(37);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__rematch_withRematch__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__rematch_store__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_next_router__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21_next_router___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_21_next_router__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__configs_default_config__ = __webpack_require__(7);
...
var Option = __WEBPACK_IMPORTED_MODULE_16_antd_lib_select___default.a.Option;
var FormItem = __WEBPACK_IMPORTED_MODULE_14_antd_lib_form___default.a.Item;
var TextArea = __WEBPACK_IMPORTED_MODULE_12_antd_lib_input___default.a.TextArea;
...
function (_React$Component) {
  ...
  _createClass(BookEdit, null, [{
    key: "getInitialProps",
    value: function () {
      var _getInitialProps = _asyncToGenerator(
      /*#__PURE__*/
      __WEBPACK_IMPORTED_MODULE_10__babel_runtime_regenerator___default.a.mark(function _callee(props) {
        return __WEBPACK_IMPORTED_MODULE_10__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                if (props.req) {
                ...
                _context.next = 3;
                return props.store.dispatch.booksPageModel.getBookByIdEffect({
                  _id: props.query.id
                });
              ...
              case 5:
                props.store.dispatch.booksPageModel.getBookByIdSuccess({
                  data: props.query.bookData
                });
  ...
  function BookEdit(props) {
    ...
    _this = _possibleConstructorReturn(this, (BookEdit.__proto__ || Object.getPrototypeOf(BookEdit)).call(this, props));
    Object.defineProperty(_assertThisInitialized(_this), "handleSubmit", {
      ...
      value: function () {
        ...
        /*#__PURE__*/
        __WEBPACK_IMPORTED_MODULE_10__babel_runtime_regenerator___default.a.mark(function _callee3(e) {
          var formData;
          return __WEBPACK_IMPORTED_MODULE_10__babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
            while (1) {
              switch (_context3.prev = _context3.next) {
                case 0:
                  e.preventDefault();
                  formData = new FormData();
                  formData.set('image', _this.props.bookPageState.fileList[0]);
                  _context3.next = 5;
                  return fetch("".concat(__WEBPACK_IMPORTED_MODULE_22__configs_default_config__["a" /* default */].nextjs.apiUrl, "/images/upload/book/").concat(_this.props.bookPageState.data[0]._id), {
                    method: 'POST',
                    headers: {
                      'authorization': _this.props.profileState.token
                    },
                    body: formData
                  });
                ...
                case 5:
                  ...
                  function () {
                    var _ref = _asyncToGenerator(
                    /*#__PURE__*/
                    __WEBPACK_IMPORTED_MODULE_10__babel_runtime_regenerator___default.a.mark(function _callee2(err, values) {
                      return __WEBPACK_IMPORTED_MODULE_10__babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
                        while (1) {
                          switch (_context2.prev = _context2.next) {
                            case 0:
                              if (err) {
                              ...
                              _context2.next = 3;
                              return _this.props.bookPageReducer.updateBookEffect({
                                _id: _this.props.bookPageState.data[0]._id,
                                title: values['title'],
                                ...
                                coverUrl: _this.props.bookPageState.fileList.length === 0 ? _this.props.bookPageState.data[0].coverUrl : "/static/images/book/image-".concat(_this.props.bookPageState.data[0]._id, ".").concat(_this.props.bookPageState.fileList[0].type.slice(6, 10))
                              });

                            case 3:
                              __WEBPACK_IMPORTED_MODULE_21_next_router___default.a.push('/dashboard/book/managenment');
    ...
    Object.defineProperty(_assertThisInitialized(_this), "getBase64", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(img, callback) {
    ...
    value: function render() {
      ...
      var uploadProps = {
        ...
        beforeUpload: function beforeUpload(file) {
          _this2.props.bookPageReducer.onChangeFileList({
            file: file
          });

          _this2.getBase64(file, function (imageUrl) {
      ...
      return __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("div", null, __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_18__components_admin_layout__["a" /* default */], {
        profileState: this.props.profileState,
        profileReducer: this.props.profileReducer
      }, __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("div", {
        style: {
          padding: '20px',
          background: '#fff'
        }
      }, __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_14_antd_lib_form___default.a, {
        onSubmit: this.handleSubmit
      }, __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("h1", null, "Book"), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("p", null, "Cover Image"), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_9_antd_lib_row___default.a, null, this.props.bookPageState.fileList.length !== 0 ? __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("img", {
        src: this.state.base64,
        width: '30%',
        style: {
          marginBottom: '20px'
        }
      }) : __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("img", {
        src: this.props.bookPageState.data[0].coverUrl,
        width: '30%',
        style: {
          marginBottom: '20px'
        }
      })), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_3_antd_lib_upload___default.a, uploadProps, __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5_antd_lib_button___default.a, null, __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_7_antd_lib_icon___default.a, {
        type: "upload"
      }), "Upload")), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](FormItem, null, getFieldDecorator('title', {
        rules: [{
          required: true,
          message: 'Please input your title!'
        }],
        initialValue: this.props.bookPageState.data[0].title
      })(__WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_12_antd_lib_input___default.a, {
        style: {
          marginTop: '40px'
        },
        placeholder: "Title",
        size: "large",
        defaultValue: this.props.bookPageState.data[0].title
      }))), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](FormItem, null, getFieldDecorator('description', {
        rules: [{
          required: true,
          message: 'Please input your description!'
        }],
        initialValue: this.props.bookPageState.data[0].description
      })(__WEBPACK_IMPORTED_MODULE_17_react__["createElement"](TextArea, {
        placeholder: "Description",
        rows: 4,
        defaultValue: this.props.bookPageState.data[0].description
      }))), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](FormItem, null, getFieldDecorator('author', {
        rules: [{
          required: true,
        ...
        placeholder: "Author",
        defaultValue: this.props.bookPageState.data[0].author
      }))), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("p", null, "Quantity"), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](FormItem, null, getFieldDecorator('quantity', {
        rules: [{
          required: true,
          message: 'Please choose your quantity!'
        }],
        initialValue: this.props.bookPageState.data[0].quantity
      })(__WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_1_antd_lib_input_number___default.a, {
        min: 0,
        placeholder: "Quantity",
        size: "default",
        defaultValue: this.props.bookPageState.data[0].quantity
      }))), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("p", null, "Borrow Price"), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](FormItem, null, getFieldDecorator('borrow-price', {
        rules: [{
          required: true,
          message: 'Please choose your borrow price!'
        }],
        ...
        size: "default",
        defaultValue: this.props.bookPageState.data[0].borrowPrice
      }))), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"]("p", null, "Status"), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](FormItem, null, getFieldDecorator('status', {
        rules: [{
          required: true,
          message: 'Please choose book status!'
        }],
        initialValue: this.props.bookPageState.data[0].status
      })(__WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_16_antd_lib_select___default.a, {
        style: {
          width: 120
        }
      }, __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](Option, {
        value: "active"
      }, "Active"), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](Option, {
        value: "deactive"
      }, "Deactive"), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](Option, {
        value: "outstock"
      }, "Out of stock")))), __WEBPACK_IMPORTED_MODULE_17_react__["createElement"](__WEBPACK_IMPORTED_MODULE_5_antd_lib_button___default.a, {
        style: {
          position: 'relative',
          left: '50%',
...
/* harmony default export */ __webpack_exports__["default"] = (Object(__WEBPACK_IMPORTED_MODULE_19__rematch_withRematch__["a" /* default */])(__WEBPACK_IMPORTED_MODULE_20__rematch_store__["b" /* initStore */], mapState, mapDispatch)(__WEBPACK_IMPORTED_MODULE_14_antd_lib_form___default.a.create()(BookEdit)));
