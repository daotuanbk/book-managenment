...
// EXTERNAL MODULE: external "antd/lib/spin/style/css"
var css_ = __webpack_require__(57);
var css__default = /*#__PURE__*/__webpack_require__.n(css_);

// EXTERNAL MODULE: external "antd/lib/spin"
var spin_ = __webpack_require__(58);
var spin__default = /*#__PURE__*/__webpack_require__.n(spin_);

// EXTERNAL MODULE: external "antd/lib/row/style/css"
var style_css_ = __webpack_require__(18);
var style_css__default = /*#__PURE__*/__webpack_require__.n(style_css_);
...
// EXTERNAL MODULE: ./components/admin-layout/index.tsx + 3 modules
var admin_layout = __webpack_require__(37);

// EXTERNAL MODULE: ./rematch/withRematch.ts
var withRematch = __webpack_require__(20);

// EXTERNAL MODULE: ./rematch/store.ts + 6 modules
var store = __webpack_require__(22);

// EXTERNAL MODULE: external "antd/lib/table/style/css"
var table_style_css_ = __webpack_require__(47);
var table_style_css__default = /*#__PURE__*/__webpack_require__.n(table_style_css_);

// EXTERNAL MODULE: external "antd/lib/table"
var table_ = __webpack_require__(48);
var table__default = /*#__PURE__*/__webpack_require__.n(table_);

// EXTERNAL MODULE: external "antd/lib/col/style/css"
var col_style_css_ = __webpack_require__(33);
var col_style_css__default = /*#__PURE__*/__webpack_require__.n(col_style_css_);

// EXTERNAL MODULE: external "antd/lib/col"
var col_ = __webpack_require__(34);
var col__default = /*#__PURE__*/__webpack_require__.n(col_);

// EXTERNAL MODULE: external "antd/lib/input/style/css"
var input_style_css_ = __webpack_require__(35);
var input_style_css__default = /*#__PURE__*/__webpack_require__.n(input_style_css_);

// EXTERNAL MODULE: external "antd/lib/input"
var input_ = __webpack_require__(36);
var input__default = /*#__PURE__*/__webpack_require__.n(input_);

// EXTERNAL MODULE: external "antd/lib/tag/style/css"
var tag_style_css_ = __webpack_require__(43);
var tag_style_css__default = /*#__PURE__*/__webpack_require__.n(tag_style_css_);

// EXTERNAL MODULE: external "antd/lib/tag"
var tag_ = __webpack_require__(44);
var tag__default = /*#__PURE__*/__webpack_require__.n(tag_);

// EXTERNAL MODULE: external "antd/lib/tooltip/style/css"
var tooltip_style_css_ = __webpack_require__(49);
var tooltip_style_css__default = /*#__PURE__*/__webpack_require__.n(tooltip_style_css_);
...
var button_style_css_ = __webpack_require__(12);
...
// CONCATENATED MODULE: ./components/book-managenment/BookList.tsx
  ...
  _createClass(BookList, [{
    ...
    value: function render() {
      ...
      var columns = [{
        ...
        fixed: 'left',
        width: 150,
        render: function render(item, _record) {
          return external__react_["createElement"]("div", null, external__react_["createElement"](link__default.a, {
            href: "/dashboard/book/edit/".concat(item._id)
          }, external__react_["createElement"](tooltip__default.a, {
            key: "".concat(item.title, "_edit"),
            title: "Edit"
          }, external__react_["createElement"](button__default.a, {
            key: "".concat(item.title, "_edit"),
            icon: "edit",
            type: "primary",
            style: {
            ...
            onClick: function onClick() {
              _this.props.bookPageReducer.updateBookEffect({
                _id: item._id,
        ...
        render: function render(item) {
          if (item === 'active') {
            return external__react_["createElement"](tag__default.a, {
              color: "green"
            }, "Active");
      ...
      }, external__react_["createElement"](row__default.a, null, external__react_["createElement"](col__default.a, {
        span: 12
      }, external__react_["createElement"](input__default.a.Search, {
        placeholder: "Search",
        style: {
          width: 500
        },
        onChange: function onChange(e) {
          return _this.props.handleSearchChange(e.target.value.toLowerCase());
        }
      }))), external__react_["createElement"](row__default.a, null, external__react_["createElement"](link__default.a, {
      ...
      }, "Add New Book"))), external__react_["createElement"](table__default.a, {
        columns: columns,
        dataSource: this.props.bookPageState.data,
        pagination: {
          ...
          onChange: function onChange(page, pageSize) {
            _this.props.bookPageReducer.fetchDataEffect({
              search: _this.props.bookPageState.searchInput,
              pageNumber: page,
              pageSize: pageSize,
              sortBy: _this.props.bookPageState.sortBy,
              asc: _this.props.bookPageState.asc
            });

            _this.props.bookPageReducer.handlePaginationChange({
              current: page,
              pageSize: pageSize
            });
          },
          onShowSizeChange: function onShowSizeChange(current, size) {
            _this.props.bookPageReducer.fetchDataEffect({
              search: _this.props.bookPageState.search,
              pageNumber: current,
              pageSize: size,
              sortBy: _this.props.bookPageState.sortBy,
              asc: _this.props.bookPageState.asc
...
/* harmony default export */ var book_managenment_BookList = (BookList_BookList);
// CONCATENATED MODULE: ./pages/dashboard/book/managenment.tsx
...
function managenment__typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { managenment__typeof = function _typeof(obj) { return typeof obj; }; } else { managenment__typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return managenment__typeof(obj); }

function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function step(key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } } function _next(value) { step("next", value); } function _throw(err) { step("throw", err); } _next(); }); }; }

function _extends() { _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; return _extends.apply(this, arguments); }

function managenment__classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }

function managenment__defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }

function managenment__createClass(Constructor, protoProps, staticProps) { if (protoProps) managenment__defineProperties(Constructor.prototype, protoProps); if (staticProps) managenment__defineProperties(Constructor, staticProps); return Constructor; }

function managenment__possibleConstructorReturn(self, call) { if (call && (managenment__typeof(call) === "object" || typeof call === "function")) { return call; } return managenment__assertThisInitialized(self); }

function managenment__inherits(subClass, superClass) { if (typeof superClass !== "function" && superClass !== null) { throw new TypeError("Super expression must either be null or a function"); } subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, enumerable: false, writable: true, configurable: true } }); if (superClass) Object.setPrototypeOf ? Object.setPrototypeOf(subClass, superClass) : subClass.__proto__ = superClass; }

function managenment__assertThisInitialized(self) { if (self === void 0) { throw new ReferenceError("this hasn't been initialised - super() hasn't been called"); } return self; }
...
var managenment_BookManagenment =
/*#__PURE__*/
function (_React$Component) {
  managenment__inherits(BookManagenment, _React$Component);

  function BookManagenment() {
    var _ref;

    var _temp, _this;

    managenment__classCallCheck(this, BookManagenment);

    for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return managenment__possibleConstructorReturn(_this, (_temp = _this = managenment__possibleConstructorReturn(this, (_ref = BookManagenment.__proto__ || Object.getPrototypeOf(BookManagenment)).call.apply(_ref, [this].concat(args))), Object.defineProperty(managenment__assertThisInitialized(_this), "handleSearchChange", {
      configurable: true,
      enumerable: true,
      writable: true,
      value: function value(searchValue) {
        _this.props.bookPageReducer.onChangeSearchValue({
          searchValue: searchValue
        });

        _this.props.bookPageReducer.fetchDataEffect({
          search: searchValue,
          pageNumber: _this.props.bookPageState.pageNumber,
          pageSize: _this.props.bookPageState.pageSize,
          sortBy: _this.props.bookPageState.sortBy,
          asc: _this.props.bookPageState.asc
        });
      }
  ...
  managenment__createClass(BookManagenment, [{
    key: "render",
    value: function render() {
      return external__react_["createElement"]("div", null, external__react_["createElement"](admin_layout["a" /* default */], {
        profileState: this.props.profileState,
        profileReducer: this.props.profileReducer
      }, external__react_["createElement"](spin__default.a, {
        spinning: this.props.bookPageState.isBusy
      }, external__react_["createElement"]("div", {
        style: {
          padding: '20px',
          background: '#fff'
        }
      }, external__react_["createElement"](row__default.a, {
        style: {
          background: '#fff'
        }
      }, external__react_["createElement"]("h1", null, "Book Managenment"), external__react_["createElement"]("hr", null)), external__react_["createElement"]("div", {
        style: {
          background: '#fff'
        }
      }, external__react_["createElement"](book_managenment_BookList, _extends({
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                bookPageState = props.store.getState().booksPageModel;
                _context.next = 4;
                return props.store.dispatch.booksPageModel.fetchDataEffect({
...
/* harmony default export */ var managenment = __webpack_exports__["default"] = (Object(withRematch["a" /* default */])(store["b" /* initStore */], mapState, mapDispatch)(managenment_BookManagenment));
