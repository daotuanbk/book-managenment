...
// CONCATENATED MODULE: ./components/lent-managenment/LentList.tsx
...
var LentList_LentList =
/*#__PURE__*/
function (_React$Component) {
  _inherits(LentList, _React$Component);

  function LentList() {
    _classCallCheck(this, LentList);

    return _possibleConstructorReturn(this, (LentList.__proto__ || Object.getPrototypeOf(LentList)).apply(this, arguments));
  }

  _createClass(LentList, [{
    key: "render",
    value: function render() {
      var _this = this;
      ...
      var columns = [{
        ...
        render: function render(item, _record) {
          return external__react_["createElement"]("div", null, external__react_["createElement"](tooltip__default.a, {
            ...
            onClick: function onClick() {
              _this.props.lentPageReducer.updateLentEffect({
                _id: item._id,
        ...
        render: function render(item) {
          return external__moment__default()(item).format('DD/MM/YYYY');
        }
      }, {
      ...
      }, external__react_["createElement"](row__default.a, null), external__react_["createElement"](table__default.a, {
        columns: columns,
        dataSource: this.props.lentPageState.data,
        pagination: {
          ...
          onChange: function onChange(page, pageSize) {
            _this.props.lentPageReducer.fetch({
              search: _this.props.lentPageState.searchInput,
              pageNumber: page,
              pageSize: pageSize,
              sortBy: _this.props.lentPageState.sortBy,
              asc: _this.props.lentPageState.asc
            });

            _this.props.lentPageReducer.handlePaginationChange({
              current: page,
              pageSize: pageSize
            });
          },
          onShowSizeChange: function onShowSizeChange(current, size) {
            _this.props.lentPageReducer.fetchDataEffect({
              search: _this.props.lentPageState.search,
              pageNumber: current,
              pageSize: size,
              sortBy: _this.props.lentPageState.sortBy,
              asc: _this.props.lentPageState.asc
...
/* harmony default export */ var lent_managenment_LentList = (LentList_LentList);
// CONCATENATED MODULE: ./pages/dashboard/lent/managenment.tsx
...
var managenment_LentManagenment =
/*#__PURE__*/
function (_React$Component) {
  managenment__inherits(LentManagenment, _React$Component);

  function LentManagenment() {
    managenment__classCallCheck(this, LentManagenment);

    return managenment__possibleConstructorReturn(this, (LentManagenment.__proto__ || Object.getPrototypeOf(LentManagenment)).apply(this, arguments));
  }

  managenment__createClass(LentManagenment, [{
    key: "render",
    value: function render() {
      return external__react_["createElement"]("div", null, external__react_["createElement"](admin_layout["a" /* default */], {
        ...
        spinning: this.props.lentPageState.isBusy
      ...
      }, external__react_["createElement"]("h1", null, "Lent Managenment"), external__react_["createElement"]("hr", null)), external__react_["createElement"]("div", {
        style: {
          background: '#fff'
        }
      }, external__react_["createElement"](lent_managenment_LentList, this.props))))));
    }
  }], [{
    key: "getInitialProps",
    value: function () {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                lentPageState = props.store.getState().lentPageModel;
                _context.next = 4;
                return props.store.dispatch.lentPageModel.fetchDataEffect({
              ...
              case 6:
                props.store.dispatch.lentPageModel.fetchDataSuccess({
                  result: props.query.lentsData
                });
...
/* harmony default export */ var managenment = __webpack_exports__["default"] = (Object(withRematch["a" /* default */])(store["b" /* initStore */], mapState, mapDispatch)(managenment_LentManagenment));
