...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ProjectI; });
...
var _jsxFileName = "/Users/Kael/Desktop/project-1/pages/_app.tsx";
...
/*#__PURE__*/
function (_App) {
  _inherits(ProjectI, _App);

  function ProjectI() {
    _classCallCheck(this, ProjectI);

    return _possibleConstructorReturn(this, (ProjectI.__proto__ || Object.getPrototypeOf(ProjectI)).apply(this, arguments));
  }

  _createClass(ProjectI, [{
    key: "render",
    value: function render() {
      var _props = this.props,
          Component = _props.Component,
